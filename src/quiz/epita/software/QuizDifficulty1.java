...
public class QuizDifficulty1 extends WindowAdapter implements ActionListener
{	
	String a,b,c,d,g;
	int z=1,sum=0;
	...
	
	{
		if (e.getSource() == b3)
		{
			...
			try
			{
				...
				{
				String s="select * from QUESTION_INFO where difficulty='1'";
		...
		if (e.getSource() == b4)		
		{
			...
			try
			{
				st=H2database.conn.createStatement();
				{
				String s="select * from QUESTION_INFO where id='"+z+"' and difficulty='1'";
				ResultSet rs=st.executeQuery(s);
