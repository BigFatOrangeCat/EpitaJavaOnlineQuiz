...
public class QuizDifficulty2 extends WindowAdapter implements ActionListener
{	
	String a,b,c,d,g;
	int z=1,sum=0;
	...
	
	{
		if (e.getSource() == b3)
		{
			...
			try
			{
				...
				{
				String s="select * from QUESTION_INFO where difficulty='2'";
		...
		if (e.getSource() == b4)		
		{
			...
			try
			{
				st=H2database.conn.createStatement();
				{
				String s="select * from QUESTION_INFO where id='"+z+"' and difficulty='2'";
				ResultSet rs=st.executeQuery(s);
